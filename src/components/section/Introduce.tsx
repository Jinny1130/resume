        ...
        <div>
            ...
            <div className="whitespace-pre-line px-1 py-3.5 text-sm sm:text-base">
                <p>
                        ...
                        <br/><br/>
                        입사 시점 "10,000개 가맹점, 월 거래 취급액 250억"에서 시작하여 "가맹점 60,000개, 월 거래 취급액 2,000억"에 이르기까지, 
                        프론트엔드 개발자로서 자사의 여러 서비스 프로젝트에 참여하여 빠르게 성장한 성과를 이룬 서비스를 개발해왔으며, 회사와 함께 성장할 수 있었습니다.
                        <br/><br/>
